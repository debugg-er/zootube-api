...
class MultipartMiddleware {
    public storeUploadFiles(req: Request, res: Response, next: NextFunction) {
        ...
        busboy.on("file", function (fieldname, file, filename, encoding, mimetype) {
            ...
            const type = /[^.]\./.exec(filename) ? /[^.]+$/.exec(filename).toString() : undefined;
